...
public interface FramesMapper {
    ...
    Frames findByMotorcycleId(@Param("motorcycleID") Long motorcycleID);
    ...
    void insertFramesData(@Param("frames") Frames frames);
    ...
    void updateFrames(@Param("motorcycleID") Long motorcycleID, @Param("frames") Frames frames);

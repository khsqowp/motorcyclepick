...
public interface EnginesMapper{
    ...
    Engines findByMotorcycleId(@Param("motorcycleID") Long motorcycleID);
    ...
    void insertEnginesData(@Param("engines") Engines engines);
    ...
    void updateEngines(@Param("motorcycleID") Long motorcycleID, @Param("engines") Engines engines);

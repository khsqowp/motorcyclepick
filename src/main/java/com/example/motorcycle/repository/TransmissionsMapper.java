...
public interface TransmissionsMapper {
    ...
    Transmissions findByMotorcycleId(@Param("motorcycleID") Long motorcycleID);
    ...
    void insertTransmissionsData(@Param("transmissions") Transmissions transmissions);
    ...
    void updateTransmissions(@Param("motorcycleID") Long motorcycleID, @Param("transmissions") Transmissions transmissions);
